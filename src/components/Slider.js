                    ...
                    >
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="zoomout">
                                ...
                                <div
                                    className="tp-caption tp-resizeme rs-parallaxlevel-3 big-ipad-hidden"
                                    data-paddingbottom="[0,0,0,0]"
                                    data-paddingleft="[0,0,0,0]"
                                    data-paddingright="[0,0,0,0]"
                                    data-paddingtop="[0,0,0,0]"
                                ...
                                >
                                    <figure>
                                        <img src="images/main-slider/icon/icon-circle-1.png" alt="" />
                                    </figure>
                                </div>
                                <div
                                    className="tp-caption tp-resizeme rs-parallaxlevel-1 big-ipad-hidden"
                                ...
                                >
                                    <figure>
                                        <img src="images/main-slider/icon/icon-circle-2.png" alt="" />
                                    </figure>
                                </div>
                                <div
                                    className="tp-caption tp-resizeme rs-parallaxlevel-1 big-ipad-hidden"
                                ...
                                >
                                    <figure>
                                        <img src="images/main-slider/icon/icon-circle-3.png" alt="" />
                                    </figure>
                                </div>
                                <div
                                    className="tp-caption tp-resizeme rs-parallaxlevel-2 big-ipad-hidden"
                                ...
                                <div
                                    ...
                                    data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                                >
                                    <Link to={'/courses'} className="theme-btn btn-style-one slider_btn">
                                        Find Course
                                    </Link>
                                </div>
                            </li>
